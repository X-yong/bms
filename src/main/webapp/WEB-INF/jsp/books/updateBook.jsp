...
<body>
	<div class="iframecontent">
		<div class="pos">
			<i class="icoh"></i> <span>图书信息修改</span>
		</div>
		<form id="fupdate" method="post" action="/bms/updateBookController/updateBook.do">
			<!-- 让表单在一行中显示form-horizontal -->
			<div class="form-group">
				<div class="col-lg-4">
					<input type="text" name="b_id" id="b_id" value="${result.b_id}" hidden/>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-lg-4">
					<input type="text" name="b_press" id="b_press" required="required"
						class="form-control" value="${result.b_press}"/>
				</div>
			</div>
				<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-lg-4">
					<input type="text" name="b_isbn" id="b_isbn" required="required"
						class="form-control" value="${result.b_isbn}"/>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-4">
					<input type="text" name="b_revision" id="b_revision" required="required"
						class="form-control" value="${result.b_revision}"/>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-4">
					<input type="number" name="b_stock" id="b_stock" required="required"
						class="form-control" value="${result.b_stock}"/>
				</div>
			</div>
			<div class="form-group">
				<label for="username" class="col-lg-2 control-label">备注<font
					style="color: red">&nbsp*&nbsp</font></label>
				<div class="col-lg-4">
					<input type="text" name="b_remark" id="b_remark" maxlength="10"
