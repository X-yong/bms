 ...
 <!-- Bootstrap -->
  ...
  <body>
	<div class="iframecontent">
		<div class="pos">
			<i class="icoh"></i> <span>读者信息</span>
		</div>
		<div class="operate">
			<div class="pull-left">
			<form id="f1"  method="post" action="${pageContext.request.contextPath}/qryUserController/qryUserInfo.do?u_role=3">
			 <input type="text" id="currPage" name="currPage" value="1" hidden/>
			    编号：<input type = "text" class="textController" name="u_id" value="${echo.u_id}" />
			    名称：<input type = "text" class="textController" name="u_name" value="${echo.u_name}" />
				...
				<input type="button" value="查询所有" onclick="searchAll(3)"  class="btn btn-info">
				<!-- <input type="button" value="新增" onclick="addUserInfo()" id="addUser" class="btn btn-success"> -->
